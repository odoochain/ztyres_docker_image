...
class AccountInvoiceReport(models.Model):
    ...
    def get_l10n_mx_edi_cfdi_uuid(self,move_id):
        return self.env['account.move'].browse(int(move_id)).l10n_mx_edi_cfdi_uuid
    ...
    def _table_query(self):
        ...
        df['l10n_mx_edi_cfdi_uuid']=df['move_id'].apply(self.get_l10n_mx_edi_cfdi_uuid)
        df.to_excel(r'/mnt/out_files/reporte_nc_fact_con_uuid.xlsx', index=False)   
    ...
    def _where(self):
        return '''
            WHERE move.move_type IN ('out_invoice', 'out_refund')
                ...
                and line."date"  BETWEEN '2022-01-01' AND '2022-10-31'
                and template."type" in ('product')
        '''
